        ...
        <div class="max-w-7xl mx-auto px-6">
            <div class="flex justify-between h-20 items-center">
                ...
                <div class="flex items-center gap-4">
                    <a href="<?php echo e(route('login')); ?>" class="hidden md:inline-flex items-center px-5 py-2.5 bg-[#e9c38c] text-black text-sm font-semibold rounded-full hover:scale-105 hover:shadow-[0_0_20px_rgba(233,195,140,0.3)] transition-all duration-300">
                        Login
                    </a>
        ...
        <div class="max-w-7xl mx-auto px-6 grid lg:grid-cols-12 gap-16 items-center">
            ...
            <div class="lg:col-span-6">
                <div class="bg-[#171a21] border border-[#242833] rounded-2xl p-8 shadow-2xl relative">
                    ...
                    <form action="<?php echo e(route('request.store')); ?>" method="POST" enctype="multipart/form-data" class="space-y-5">
                        <?php echo csrf_field(); ?>
        ...
        <div class="max-w-7xl mx-auto px-6">
            ...
            <div class="border-t border-[#242833] pt-8 flex flex-col md:flex-row justify-between items-center gap-4">
                <p class="text-sm text-gray-500">
                    © <?php echo e(date('Y')); ?> INLOCK. All rights reserved.
                </p>
                <p class="text-sm text-gray-500">
...
</html><?php /**PATH C:\xampp\htdocs\dashboard\inlocky\resources\views\welcome.blade.php ENDPATH**/ ?>